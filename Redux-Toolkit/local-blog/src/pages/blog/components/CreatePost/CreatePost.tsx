import { addPost, cancelEditingPost, finishingEditingPost } from 'pages/blog/blog.slice'
...
export default function CreatePost() {
  ...
  // handle editing
  useEffect(() => {
    //nếu mà edittingPost null thì lấy initialState
  ...
  const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    e.preventDefault()
    if (editingPost) {
      dispatch(finishingEditingPost(formData))
    } else {
      ...
      <form onSubmit={handleSubmit} onReset={handleCancelEditingPost}>
        <div className='mb-6'>
          <label
            ...
            onClick={() => dispatch({ type: 'blog/cancel1' })}
          >
            Title
          </label>
          <input
